...
module.exports = {
  ...
  construct: (self, options) => {
    ...
    self.on('apostrophe-docs:beforeSave', 'setProjectsCreated', async function(req, piece) {
      ...
      // FIXME: this is a shitty hack because reverse relations dont work (#57).
      // also, this shitty hack does not even work, only works in draft mode...
      // see https://stackoverflow.com/questions/62503054/how-to-properly-handle-joinbyarrayreverse-with-multiple-types
      // see https://github.com/jansensan/arts-et-medias/issues/57
