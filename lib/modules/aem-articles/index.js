...
module.exports = {
  ...
  addFields: [
    ...
    // citations
    {
      ...
      help: 'Check this box to generate citations. If unchecked, previous citations will be deleted.',
      name: 'hasCitations',
      type: 'select',
      choices: [
        {
    ...
    {
      label: 'Citation Type',
      htmlHelp: '<p>The citation affects the format of the generated citation.</p>',
      name: 'citationType',
      type: 'select',
      required: false,
      choices: [
