/* global _, apos, sluggo, arguments */
...
apos.define('apostrophe-browser-utils', {
  construct: (self, options) => {
    ...
    self.globalReplace = (haystack, needle, replacement) => {
      var result = '';
    ...
    self.clonePermanent = (o, keepScalars) => {
      var c;
