...
require.register("components/mobile-menu", function(exports, require, module) {
"use strict";
...
// models
var breakpointModel = require('../models/breakpoints-model'); // dom elements


var openMenuButton = undefined;
var closeMenuButton = undefined;
var overlay = undefined;
var menu = undefined; // vars

var isVisible = false; // public api
...
function hideMenu() {
  ...
  overlay.classList.remove('visible'); // allow scrolling
...
function showMenu() {
  ...
  overlay.classList.add('visible'); // disallow scrolling
...
;require.register("constants/breakpoint", function(exports, require, module) {
"use strict";
...
var Breakpoint = {
  ...
  MEDIUM_DESKTOP: 1280,
  LARGE_DESKTOP: 1440,
  HIGH_DEFINITION: 1920
};
var _default = Breakpoint;
exports["default"] = _default;
});

require.register("constants/column-width", function(exports, require, module) {
"use strict";
...
var _default = ColumnWidth;
exports["default"] = _default;
});

require.register("constants/content-width", function(exports, require, module) {
"use strict";
...
var _default = ContentWidth;
exports["default"] = _default;
});

require.register("constants/gutter-width", function(exports, require, module) {
"use strict";
...
var modulesList = [// models
'models/breakpoints-model', // components
'components/mobile-menu']; // methods definitions

function initAll() {
  // import all *.js files and `init()` them
  modulesList.forEach(function (m) {
    // require module
    var loadedModule = require("./".concat(m)); // init() if method exists
...
require.register("models/breakpoints-model", function(exports, require, module) {
"use strict";
...
exports.getCurrentColumnWidth = getCurrentColumnWidth;
exports.getCurrentGutterWidth = getCurrentGutterWidth;
exports.isMobile = isMobile;

// constants
var Breakpoint = require('../constants/breakpoint')["default"];

var ColumnWidth = require('../constants/column-width')["default"];

var GutterWidth = require('../constants/gutter-width')["default"]; // vars


var currentWidth = undefined;
var currentBreakpoint = undefined; // public api
...
function getCurrentGutterWidth() {
  var width = -1;
...
function getWindowWidth() {
  return Math.max(document.body.scrollWidth, document.documentElement.scrollWidth, document.body.offsetWidth, document.documentElement.offsetWidth, document.documentElement.clientWidth); // from https://stackoverflow.com/questions/1038727/how-to-get-browser-width-using-javascript-code
}
...
;require.register("src/utils/copy-field", function(exports, require, module) {
"use strict";
