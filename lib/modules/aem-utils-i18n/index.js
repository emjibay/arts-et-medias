...
function constructHelpers(self, options) {
  ...
  function getCountry(countryCode, locale) {
    ...
    if (!locale) {
      console.warn('getCountry() expects `locale`, a two-letter language code, as second parameter.');
  ...
  function getLanguage(languageCode, locale) {
    ...
    if (!locale) {
      console.warn('getLanguage() expects `locale`, a two-letter language code, as second parameter.');
  ...
  function isFirstCharVowel(str) {
    if (!str) {
      console.warn('isFirstCharVowel() expects a string, but none was provided.');
      return false;
    }
